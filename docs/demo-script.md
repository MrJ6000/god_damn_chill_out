...
| 2:22–2:43 | Show the benchmark result in the repository or prepared terminal output. | “The offline adversarial suite contains 100 reproducible cases. In the recorded run, all expected outcomes matched and no malicious payment executed.” | The committed result file, including run time, totals, and category counts. |
